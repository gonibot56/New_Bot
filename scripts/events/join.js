...
.then(response => {
    ...
    return api.sendMessage("চলে এসেছি আমি Goni Bot🥀😉🤖", event.threadID, () => api.sendMessage({ body: `${global.config.BOTNAME} 𝗖𝗼𝗻𝗻𝗲𝗰𝘁𝗲𝗱 ↤
...
✿︎ 𝗡𝗮𝗺𝗲: 𝐀𝐁𝐃𝐔𝐋 𝐆𝐎𝐍𝐈 𝐒𝐇𝐀𝐖𝐎𝐍

✷ 𝗙𝗮𝗰𝗲𝗯𝗼𝗼𝗸: 
https://www.facebook.com/gaminggoni2005

❊ 𝗣𝗮𝗿𝘀𝗼𝗻𝗮𝗹 𝗙𝗮𝗰𝗲𝗯𝗼𝗼𝗸 : https://www.facebook.com/goni2005

✲ 𝗧𝗲𝗹𝗲𝗴𝗿𝗮𝗺: 𝐍𝐀𝐈

❁ 𝗘𝗺𝗮𝗶𝗹: abdulgonishawon@gmail.com

✿ 𝗪𝗣: 01615804476`, attachment: fs.createReadStream(gifPath)}, threadID));
})
.catch(error => {
    console.error(error);
});
